...
export const PLAN_FEATURES: PlanFeature[] = [
  ...
  { key: "feature_show_branding", label: "Show nnFlow by Nevorai Watermark", type: "boolean", category: "Features", hint: "If on, public funnel/landing/video pages show 'Made with nnFlow by Nevorai' badge", dbField: "feature_show_branding" },
