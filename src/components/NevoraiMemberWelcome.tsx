    ...
    <Dialog open={open} onOpenChange={(v) => !v && handleClose()}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogTitle className="text-center text-xl">🎉 Welcome to nnFlow by Nevorai!</DialogTitle>
          <DialogDescription className="text-center space-y-2 pt-2">
            <span className="block">
              Because you're a Nevorai Pro member, you have free access to the nnFlow by Nevorai Individual plan.
            </span>
