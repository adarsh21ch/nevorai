    ...
    <Dialog open={open} onOpenChange={(o) => !o && handleClose()}>
      <DialogContent className="bg-card border-border max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
            ...
            <div className="rounded-lg border border-indigo-500/20 bg-indigo-500/10">
              ...
              <CollapsibleContent className="overflow-hidden data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down">
                <div className="px-3 pb-3 text-sm text-muted-foreground space-y-2">
                  ...
                  <p>
                    Videos downloaded from YouTube play the smoothest on nnFlow by Nevorai. If your video lags or buffers, try this:
                  </p>
          ...
          {/* Allow viewers to reuse this video via nnFlow by Nevorai Link */}
          <div className="flex items-start justify-between gap-3 p-3 rounded-lg bg-muted/40 border border-border">
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xs text-muted-foreground mt-1 leading-relaxed">
                Public viewers see a "Copy nnFlow by Nevorai Link" button so they can add this video to their own gallery. Daily view limits still apply.
              </p>
            </div>
            <Switch
              id="allow-copy-link"
