...
const items = [
  {
    ...
    quote:
      "I used to send YouTube links and follow up manually for days. With nnFlow by Nevorai, my prospect watches the full video, their number is captured automatically, and I get a WhatsApp lead instantly. My conversion went from 6% to almost 20%.",
  },
  {
    name: "Rahul M.",
    ...
    <section className="py-20 sm:py-24 relative">
      <div className="container-app max-w-6xl">
        ...
        >
          ...
          <p className="text-hero-muted">Network marketers and entrepreneurs using nnFlow by Nevorai.</p>
        </motion.div>
