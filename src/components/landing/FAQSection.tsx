...
const faqs = [
  {
    q: "What is nnFlow by Nevorai?",
    a: "nnFlow by Nevorai is a video-based follow-up system that helps you control how prospects watch, understand, and respond to your message.",
  },
  {
  ...
  {
    q: "Who is nnFlow by Nevorai for?",
