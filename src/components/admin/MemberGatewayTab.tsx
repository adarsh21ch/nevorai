        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            <p className="text-xs text-muted-foreground mt-1">
              When enabled, Nevorai calling app Pro users automatically get Individual plan access in nnFlow by Nevorai.
            </p>
          </div>
          <Switch
            ...
            <div className="space-y-2 pt-3 border-t border-border/40">
              ...
              <pre className="bg-muted/40 rounded-lg p-3 text-[11px] whitespace-pre-wrap font-sans text-muted-foreground">
                {settings.notification_template
                  .replace("{{name}}", "[Name]")
                  .replace("{{login_url}}", "[nnFlow by Nevorai login link]")}
              </pre>
              <p className="text-[10px] text-muted-foreground">
      ...
      <div className="glass-card p-4 sm:p-5 space-y-3">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {members.length} Nevorai member{members.length === 1 ? "" : "s"} in nnFlow by Nevorai
            </p>
          </div>
