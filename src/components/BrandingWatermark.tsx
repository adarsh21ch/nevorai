...
/**
 * Small "Powered by nnFlow by Nevorai" badge shown on public pages owned by Free-tier users.
...
export const BrandingWatermark = ({
  ...
  return (
    <div className={wrapper}>
      <a
        href="https://nnFlow by Nevorai.app/?ref=watermark"
        target="_blank"
        rel="noopener noreferrer"
        className={`${base} ${palette}`}
        aria-label="Powered by nnFlow by Nevorai"
      >
        <span className="h-1.5 w-1.5 rounded-full bg-emerald-500" />
        Powered by <span className="font-semibold">nnFlow by Nevorai</span>
      </a>
    </div>
  );
};
