    ...
    <div className="min-h-[100dvh] bg-background">
      ...
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-6">
          ...
          return (
            <div className="glass-card p-6 sm:p-10 text-center space-y-6">
              ...
              <p className="text-[10px] text-muted-foreground pt-2">
                Powered by <span className="text-primary font-semibold">nnFlow by Nevorai</span> by Nevorai
              </p>
            </div>
          );
        })()}
        ...
        <div className="text-center pt-4">
          <p className="text-[10px] text-muted-foreground"><span className="text-primary font-semibold">nnFlow by Nevorai</span> by Nevorai</p>
        </div>
      </div>
    </div>
  );
