...
const PublicFunnel = () => {
  ...
  useEffect(() => {
    if (!funnel) return;
    document.title = `${funnel.title} | nnFlow by Nevorai`;
    ...
    setMeta("og:site_name", "nnFlow by Nevorai", true);
    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          <img src={logoImg} alt="nnFlow by Nevorai" className="h-6 w-6" />
      ...
      <div className="flex-1 flex flex-col max-w-6xl mx-auto px-4 py-8 w-full">
        ...
        <div className="mt-16 pt-6 pb-8 text-center" style={{ borderTop: `1px solid ${tc.footerBorder}` }}>
          <p className="text-[11px] tracking-wide" style={{ color: tc.footerText }}>© {new Date().getFullYear()} nnFlow by Nevorai · All rights reserved</p>
        </div>
      </div>
      )}
