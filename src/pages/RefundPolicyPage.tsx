        ...
        <div className="container-app max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-10 pb-8 border-b border-border">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              We offer a 7-day money-back guarantee on all paid plans. If nnFlow by Nevorai doesn't work for you,
          ...
          <div className="space-y-8 text-sm text-muted-foreground leading-relaxed">
            <section>
              ...
              <p className="mb-3">
                We believe in nnFlow by Nevorai. If you subscribe to any paid plan and are not satisfied within
                <strong className="text-foreground"> 7 days of your payment date</strong>, you can request a full refund.
              </p>
              <p>
                This is in addition to our free trial — so you have tried nnFlow by Nevorai for free before paying, and
