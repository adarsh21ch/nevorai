...
const defaultFormState = {
  ...
  sender_display_name: "nnFlow by Nevorai",
              ...
              <div>
                ...
                <div className="mt-2 space-y-2">
                  <label className={`flex items-center gap-3 p-3 rounded-lg border cursor-pointer transition-all ${
                    form.sender_display_name === "nnFlow by Nevorai" ? "border-primary bg-primary/5" : "border-border bg-muted/50"
                  }`}>
                    <input type="radio" name="sender_display_name" checked={form.sender_display_name === "nnFlow by Nevorai"} onChange={() => updateField("sender_display_name", "nnFlow by Nevorai")} className="accent-primary" />
                    <div>
                      <p className="text-sm font-medium">Platform Name</p>
                      <p className="text-xs text-muted-foreground">nnFlow by Nevorai</p>
                    </div>
                  </label>
                  <label className={`flex items-center gap-3 p-3 rounded-lg border cursor-pointer transition-all ${
                    form.sender_display_name !== "nnFlow by Nevorai" ? "border-primary bg-primary/5" : "border-border bg-muted/50"
                  }`}>
                    <input type="radio" name="sender_display_name" checked={form.sender_display_name !== "nnFlow by Nevorai"} onChange={() => updateField("sender_display_name", form.sender_display_name !== "nnFlow by Nevorai" ? form.sender_display_name : (profile?.full_name || ""))} className="accent-primary" />
                    <div className="flex-1">
                      <p className="text-sm font-medium">Custom Name</p>
                      {form.sender_display_name !== "nnFlow by Nevorai" && (
