        ...
        <div className="container-app max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-10 pb-8 border-b border-border">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              By creating an account or using nnFlow by Nevorai, you agree to these Terms of Service. Please read them
              carefully. If you do not agree, do not use nnFlow by Nevorai.
            </p>
          </motion.div>

          <div className="space-y-8 text-sm text-muted-foreground leading-relaxed">
            <section>
              <h2 className="text-lg font-heading font-semibold text-foreground mb-3">1. About nnFlow by Nevorai</h2>
              <p>
                nnFlow by Nevorai is a distraction-free video funnel platform built by Nevorai for creators, coaches, and
                educators. These terms govern your use of the nnFlow by Nevorai application and all related services.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                After the trial ends, you must subscribe to a paid plan to continue using nnFlow by Nevorai. Your data is
            ...
            <section>
              ...
              <p className="mb-3">You agree NOT to use nnFlow by Nevorai to:</p>
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>Resell or white-label nnFlow by Nevorai without written permission from Nevorai.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                You own your content — videos, funnels, landing pages, leads, and any media you upload to nnFlow by Nevorai.
                By using nnFlow by Nevorai, you grant Nevorai a limited licence to store, process, transcode, and stream
            ...
            <section>
              ...
              <p className="mb-3">
                nnFlow by Nevorai is provided "as is". Nevorai is not liable for any indirect, incidental, or consequential
