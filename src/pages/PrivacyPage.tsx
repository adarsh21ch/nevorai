        ...
        <div className="container-app max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-10 pb-8 border-b border-border">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              nnFlow by Nevorai respects your privacy. This policy explains what data we collect, how we use it,
          ...
          <div className="space-y-8 text-sm text-muted-foreground leading-relaxed">
            <section>
              ...
              <p className="mb-3">
                nnFlow by Nevorai is a product of Nevorai. We build a distraction-free video funnel platform for creators,
                coaches, and educators. When we say "nnFlow by Nevorai", "we", "us", or "our" in this policy, we mean
                Nevorai and the nnFlow by Nevorai application.
              </p>
              <p>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li><strong className="text-foreground">Funnel content:</strong> Videos, thumbnails, copy, and any media you upload to nnFlow by Nevorai.</li>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2 mb-3">
                <li>Provide and improve the nnFlow by Nevorai service.</li>
            ...
            <section>
              ...
              <p>
                nnFlow by Nevorai is not intended for users under the age of 18. We do not knowingly collect data from minors.
            ...
            <section>
              ...
              <p>
                ...
                if we make significant changes. Continued use of nnFlow by Nevorai after changes means you accept the
                updated policy.
              </p>
            </section>
