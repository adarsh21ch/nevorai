      ...
      <div className="min-h-screen flex items-center justify-center bg-background p-4">
        <Card className="p-8 text-center max-w-md w-full space-y-4">
          ...
          <h1 className="text-xl font-bold">You're using the app!</h1>
           <p className="text-sm text-muted-foreground">nFlow is already installed on your device.</p>
      ...
      <main className="flex-1 px-4 py-8 max-w-lg mx-auto w-full space-y-6">
        <div className="text-center space-y-2">
          <div className="w-20 h-20 rounded-2xl overflow-hidden mx-auto shadow-lg">
            <img src="/icons/icon-512x512.png" alt="nFlow" className="w-full h-full" />
          </div>
          <h1 className="text-2xl font-bold mt-4">Install nFlow</h1>
        ...
        {installed ? (
          <Card className="p-6 text-center space-y-3 border-primary/20">
            ...
            <p className="text-sm text-muted-foreground">You can now find nFlow on your home screen.</p>
          </Card>
        ) : deferredPrompt ? (
