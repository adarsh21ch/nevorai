...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "nnFlow by Nevorai" },
      { name: "description", content: "nnFlow by Nevorai is a web application for managing marketing funnels, landing pages, and live sessions." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "nnFlow by Nevorai" },
      { property: "og:description", content: "nnFlow by Nevorai is a web application for managing marketing funnels, landing pages, and live sessions." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "nnFlow by Nevorai" },
      { name: "twitter:description", content: "nnFlow by Nevorai is a web application for managing marketing funnels, landing pages, and live sessions." },
      ...
      { name: "apple-mobile-web-app-title", content: "nnFlow by Nevorai" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "application-name", content: "nnFlow by Nevorai" },
    ],
    links: [
